...
<head>
    ...
    <title>Discover || Restaurant Manager</title>
    <!-- Favicon icon -->
        ...
        <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="{{ route('restaurant-manager.dashboard') }}" class="has-arrow">
                            <i class="fas fa-tachometer-alt me-2"></i> Tableau de bord
                        </a>
                        
                    </li>
                    <li class="mega-menu mega-menu-sm">
                        <a href="{{ route('restaurant-manager.restaurants.index') }}" class="has-arrow">
                    ...
                    <li>
                        <a href="{{ route('restaurant-manager.reservations.index') }}" class="has-arrow">
