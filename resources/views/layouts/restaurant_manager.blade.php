...
<body>
    ...
    ***********************************-->
    <!-- jQuery -->
    <script src="{{ asset('assets_restaurant/js/vendor/jquery-3.2.1.min.js') }}"></script>
    <!-- Bootstrap JS -->
    <script src="{{ asset('assets_restaurant/js/popper.min.js') }}"></script>
    <script src="{{ asset('assets_restaurant/js/bootstrap.min.js') }}"></script>
    <!-- Custom JS -->
